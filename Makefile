...
pkgdatadir = $(datadir)/weex
pkglibdir = $(libdir)/weex
pkgincludedir = $(includedir)/weex
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
CATALOGS =  ja.gmo de.gmo es.gmo nl.gmo fr.gmo
CATOBJEXT = .gmo
CC = gcc
DATADIRNAME = share
GENCAT = 
GMOFILES =  ja.gmo de.gmo es.gmo nl.gmo fr.gmo
...
PACKAGE = weex
POFILES =  ja.po de.po es.po nl.po fr.po
POSUB = po
RANLIB = ranlib
